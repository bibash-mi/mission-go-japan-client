...
export class OnlineFormComponents implements OnInit {
    ...
    submit() {
        ...
        this.studentsService.onlineApplication(this.student).subscribe((data: any) => {
            ...
            this.toastr.error("Your application is submission failed. Please try again or reach out to your school.", "ERROR", { timeOut: 9000, positionClass: "toast-bottom-center" })
            this.loading = false;
        })
    }
}